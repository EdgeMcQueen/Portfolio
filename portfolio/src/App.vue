<template>
  <div id="app">
    ...
    <!-- Header -->
    <Header :navClass="nav.navClass" :navList="nav.navList" />
    <!-- DropdownMenu -->
    ...
    <main class="main-content">
      <section id="aboutMe" class="aboutMe section--wrapper section--grey">
        <div class="container">
          ...
          <p class="aboutMe__text">
            Здравствуйте, меня зовут Сардор - я начинающий Front-end
            разработчик. Основная часть работы это верстка и дополнение сайтов
            на HTML/CSS/JS. Так же обладаю навыками работы с препроцессором
            SCSS, сборщиком пакетов Gulp, библиотекой JQuery.
            <br />
            <br />
            Имею малый, но стремительно развивающийся, опыт в веб-разработке. С
            каждым днём стараюсь изучать и применять что-то новое из данной
            сферы.
            <br />
            <br />
            Так же обладаю такими навыками, как стрессоустойчивость,
            коммуникабельность, быстро обучаемость и усидчивость.
          </p>
          <a href="resume.pdf" class="aboutMe__cv main-link-btn" download
            >Скачать резюме</a
          >
        </div>
      </section>
      <!-- end about me block -->
      <section id="skills" class="skills section--wrapper">
        <div class="container">
      ...
      <!-- end skills block -->
      <section id="portfolio" class="portfolio section--wrapper section--grey">
        <div class="container">
          ...
          <div class="portfolio__item">
            <a
              href="https://sardormutalov.github.io/Arrow/app/index.html"
              class="portfolio__preview"
              target="_blank"
            >
              <img
                src="img/portfolio/arrow.jpg"
                alt=""
          ...
          <div class="portfolio__item">
            <a
              href="https://sardormutalov.github.io/SingleWebPage/index.html"
              class="portfolio__preview"
              target="_blank"
            >
              <img
                src="img/portfolio/singleWebPage.jpg"
                alt=""
                class="portfolio__img"
              />
            </a>
          ...
          <div class="portfolio__item">
            <a
              href="https://sardormutalov.github.io/Corp-study-mokup/index.html"
              class="portfolio__preview"
              target="_blank"
            >
              <img
                src="img/portfolio/corpStudyMockup.jpg"
                alt=""
                class="portfolio__img"
              />
            </a>
    ...
    <div class="container">
      <footer id="contacts" class="main-footer">
        <section class="contacts section--wrapper">
          ...
          <a
            href="mailto:sardor.mutalov@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
            class="contacts__msg-link main-link-btn"
            >Написать письмо</a
          >
          <div class="contacts__social">
            <a
              href="https://vk.com/edgardmcqueen"
              class="social__link"
              target="_blank"
            >
              <svg
            ...
            <a
              href="https://www.instagram.com/edgardmcqueen/"
              class="social__link"
              target="_blank"
            >
              <svg
            ...
            <a
              href="https://github.com/SardorMutalov"
              class="social__link"
              target="_blank"
            >
              <svg
...
import DropdownMenu from "@/components/Header/DropdownMenu/DropdownMenu.vue";
import BurgerMenu from "@/components/Header/BurgerMenu/BurgerMenu.vue";
  ...
  data() {
    return {
      nav: {
        navClass: "nav-menu",
        navList: [
          { href: "#home", content: "Главная" },
          { href: "#aboutMe", content: "О себе" },
          { href: "#skills", content: "Навыки" },
          { href: "#portfolio", content: "Портфолио" },
